...
$(document).ready(function () {
    ...
    ///disable numeric input on .digit class
    ...
    ///switch to next field on key up on cc digits and date onkeyup
    $('.digits').keypress(function () {
...
///reset error/success onfocus
$("input").focus(function (event) {
    $(this).removeClass("errorRed");
    $(this).removeClass("successsGreen");
});
